...
class Error2 extends Exception
{
	...
	{
		set_error_handler( array( 'Error2', 'error_handler' ) );
		set_exception_handler( array( 'Error2', 'exception_handler' ) );
		register_shutdown_function( array( 'Error2', 'shutdown_handler' ) );
	}
...
debug::out( $exception->getMessage() ); 
