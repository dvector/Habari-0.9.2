 ...
 * @package Habari
 */
session_start(); // 33v placed here for php 7, doesnt work in xampp when in original place further down
...
ob_start();
// require_once( "C:\_htdocs\hekomanspace.com\alt/system/classes/error.php" );
